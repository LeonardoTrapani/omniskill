...
```
./[[resource:a4832bc4-c1e2-4a77-8b56-2eb2dd51275a]]           # Start here for React
./[[resource:cac7f3d9-c1d1-4292-8880-23b7f17dbcdf]]              # React components and hooks
./[[resource:c0f6e6d9-2fde-46b3-819b-e35b02ded408]]    # Solid project setup
...
| --------- | --------------------------------- | -------------------------------------- |
| Core      | `./[[resource:e86fd3aa-7c54-4dd3-9078-8e6476d31257]]`  | Imperative API, all primitives         |
| React     | `./[[resource:a4832bc4-c1e2-4a77-8b56-2eb2dd51275a]]` | React reconciler for declarative TUI   |
...
| Keyboard   | `./[[resource:ed39f659-0857-499f-b617-c48b5ca89afd]]`   | Keyboard input handling         |
| Animation  | `./references/animation/REFERENCE.md`  | Timeline-based animations       |
| Testing    | `./[[resource:b840040d-9d58-4b4c-8531-766a36a874bb]]`    | Test renderer and snapshots     |
...
| Containers     | `./[[resource:b8cd2cd0-4164-473f-b332-99d12e70b1aa]]`   | box, scrollbox, borders             |
| Inputs         | `./references/components/inputs.md`       | input, textarea, select, tab-select |
| Code & Diff    | `./[[resource:d98a897e-7317-4df5-8f28-1c5092d6a563]]`    | code, line-number, diff, markdown   |
