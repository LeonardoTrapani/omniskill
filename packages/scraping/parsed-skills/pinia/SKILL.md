...
|-------|-------------|-----------|
| Stores | Defining stores, state, getters, actions, storeToRefs, subscriptions | [[resource:b9184c81-937d-4dbb-9f06-b03c83fe2aba]] |
...
| Topic | Description | Reference |
|-------|-------------|-----------|
| Plugins | Extend stores with custom properties, state, and behavior | [[resource:997c4656-30a0-4ada-9567-8edc2ee09136]] |
...
| Topic | Description | Reference |
|-------|-------------|-----------|
| Testing | Unit testing with @pinia/testing, mocking, stubbing | [[resource:e77bd540-5f62-47ad-a6cb-dc1f14f43bdb]] |
| Outside Components | Using stores in navigation guards, plugins, middlewares | [[resource:a540ecd6-8ee3-4312-b746-56cf584c5acc]] |

## Advanced

| Topic | Description | Reference |
|-------|-------------|-----------|
| SSR | Server-side rendering, state hydration | [[resource:d9c28bde-3240-46e5-b932-2d01b31cf0d1]] |
