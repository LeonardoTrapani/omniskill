...
- Before implementing any Vue task, make sure to read and apply these core references:
  - [[resource:0033ff19-3e27-4007-9935-88f3f69cb9ef]]
  - `references/sfc.md`
  - [[resource:c0ac3501-2ae7-4899-87d0-69712ab5f653]]
...
- Must-read reference from `1.1`: [[resource:0033ff19-3e27-4007-9935-88f3f69cb9ef]]
...
- Must-read reference from `1.1`: [[resource:c0ac3501-2ae7-4899-87d0-69712ab5f653]]
...
- Fallthrough attributes: wrapper/base components must forward attrs/events safely -> [[resource:94f16d42-908d-4b01-908c-ec98ffcb305e]]
- Built-in component `<KeepAlive>` for stateful view caching -> [[resource:f1f38249-ddf3-4fac-bd36-739e1fc388f5]]
- Built-in component `<Teleport>` for overlays/portals -> [component-teleport](references/component-teleport.md)
- Built-in component `<Suspense>` for async subtree fallback boundaries -> [[resource:fdc5dcb8-f66d-4a36-9dca-d38e0d647fc0]]
- Animation-related features: pick the simplest approach that matches the required motion behavior.
  - Built-in component `<Transition>` for enter/leave effects -> [[resource:ed0a03f2-63c5-44c0-b83a-36c3bc68457f]]
  - Built-in component `<TransitionGroup>` for animated list mutations -> [[resource:ae1e8a1f-4a4f-41f0-994f-d1ea046a4a54]]
  - Class-based animation for non-enter/leave effects -> [[resource:c0a0c577-3efc-4cb3-819b-5408b359054d]]
  - State-driven animation for user-input-driven animation -> [[resource:cb549e00-a1b9-45cb-8933-cbbe9f4b8619]]
...
- Plugins when behavior must be installed app-wide -> [[resource:f8b8fc3c-09db-459d-bdf6-ce11abf0a456]]
...
- Large list rendering bottlenecks -> [[resource:eb6aa0f6-8bfb-4a36-8b7e-f69006fab716]]
