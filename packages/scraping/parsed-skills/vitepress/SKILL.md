...
| CLI | Command-line interface: dev, build, preview, init | [[resource:0311fe20-661b-4f6e-84d9-e6bc51312e24]] |
| Routing | File-based routing, source directory, rewrites | [core-routing](references/core-routing.md) |
| Markdown | Frontmatter, containers, tables, anchors, includes | [[resource:ab5a9eaa-d311-4169-8dcf-83abea7c48d5]] |
...
| Dynamic Routes | Generate pages from data, paths loader files | [[resource:fb7e2daa-2852-4213-a351-821ec6a66205]] |
...
| Custom Theme | Building themes from scratch, theme interface | [[resource:c518ce49-d242-4131-adea-68a613ca696e]] |

## Advanced

| Topic | Description | Reference |
|-------|-------------|-----------|
| Internationalization | Multi-language sites, locale configuration | [[resource:b684bbc0-8441-4970-8b07-918c01e2b539]] |
