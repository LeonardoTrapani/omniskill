...
├─ Handle environment variables → [[resource:fc6d31e7-b9e8-482b-a68e-8f3f6fc1f6a9]]
...
├─ Remote cache not working → [[resource:e505686c-d578-4073-b140-0e0e53d175b4]]
...
```
CI setup?
├─ GitHub Actions → [[resource:c1292a83-a6f3-4cd4-97d5-2b87fcec159b]]
├─ Vercel deployment → [[resource:f2c2f75c-e75e-4f60-9120-ae03aa1063ba]]
├─ Remote cache in CI → [[resource:e505686c-d578-4073-b140-0e0e53d175b4]]
├─ Only build changed packages → --affected flag
├─ Skip unnecessary builds → turbo-ignore ([[resource:d630abcf-52e8-4005-ab4c-d4932f29fec4]])
...
├─ Repository structure → [[resource:b3c61100-17fc-4358-9c11-006090493e95]]
├─ Dependency management → references/best-practices/dependencies.md
├─ Best practices overview → [[resource:01972ca6-02a6-425e-a8a7-3a6dc3a6f8c4]]
├─ JIT vs Compiled packages → references/best-practices/packages.md#compilation-strategies
└─ Sharing code between apps → [[resource:01972ca6-02a6-425e-a8a7-3a6dc3a6f8c4]]
```
...
```
Monorepo structure?
├─ Standard layout (apps/, packages/) → [[resource:01972ca6-02a6-425e-a8a7-3a6dc3a6f8c4]]
├─ Package types (apps vs libraries) → [[resource:01972ca6-02a6-425e-a8a7-3a6dc3a6f8c4]]
├─ Creating internal packages → references/best-practices/packages.md
├─ TypeScript configuration → [[resource:b3c61100-17fc-4358-9c11-006090493e95]]
├─ ESLint configuration → [[resource:b3c61100-17fc-4358-9c11-006090493e95]]
├─ Dependency management → references/best-practices/dependencies.md
└─ Enforce package boundaries → [[resource:ebd49583-b1e9-488f-bbe3-d43a062cd451]]
```
...
├─ Tag packages → [[resource:ebd49583-b1e9-488f-bbe3-d43a062cd451]]
├─ Restrict which packages can import others → [[resource:ebd49583-b1e9-488f-bbe3-d43a062cd451]]
└─ Prevent cross-package file imports → [[resource:ebd49583-b1e9-488f-bbe3-d43a062cd451]]
```
...
| File                                                            | Purpose                                      |
| --------------------------------------------------------------- | -------------------------------------------- |
| [[resource:a0df8ef9-39f9-4fab-9926-5f8ae2d3bdf7]]                 | How caching works, hash inputs               |
| [[resource:e505686c-d578-4073-b140-0e0e53d175b4]] | Vercel Remote Cache, self-hosted, login/link |
...
| File                                                          | Purpose                                   |
| ------------------------------------------------------------- | ----------------------------------------- |
| [[resource:fc6d31e7-b9e8-482b-a68e-8f3f6fc1f6a9]]       | env, globalEnv, passThroughEnv            |
...
| [[resource:c1292a83-a6f3-4cd4-97d5-2b87fcec159b]] | Complete GitHub Actions setup   |
| [[resource:f2c2f75c-e75e-4f60-9120-ae03aa1063ba]]                 | Vercel deployment, turbo-ignore |
| [[resource:e6073450-0940-41e0-b051-bdd30507f4d4]]             | --affected, caching strategies  |
...
| [[resource:d630abcf-52e8-4005-ab4c-d4932f29fec4]] | turbo run flags, turbo-ignore, other commands |

### Best Practices

| File                                                                          | Purpose                                                         |
| ----------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [[resource:01972ca6-02a6-425e-a8a7-3a6dc3a6f8c4]]                 | Monorepo best practices overview                                |
| [[resource:b3c61100-17fc-4358-9c11-006090493e95]]       | Repository structure, workspace config, TypeScript/ESLint setup |
...
| File                                                  | Purpose                                               |
| ----------------------------------------------------- | ----------------------------------------------------- |
| [[resource:ebd49583-b1e9-488f-bbe3-d43a062cd451]] | Enforce package isolation, tag-based dependency rules |
