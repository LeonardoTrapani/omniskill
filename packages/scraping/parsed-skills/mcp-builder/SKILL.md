...
Copy and customise `[[resource:eec9e0a5-3ab3-405d-8ecb-1ac2c084055b]]`:
...
See `[[resource:bf6a1947-050a-43da-b4f0-dac6740a2eab]]` and `[[resource:95c2202a-06fe-4421-821b-30ee151238d6]]` for TypeScript templates.
...
- `[[resource:eec9e0a5-3ab3-405d-8ecb-1ac2c084055b]]` — Minimal FastMCP server template
- `[[resource:a428ba5b-3176-40ba-95f1-63872af7284e]]` — Server with storage and middleware
- `[[resource:ff6300f6-b3b7-45c2-8183-39db8a503738]]` — Tool patterns and type annotations
- `[[resource:07c6fbf3-a936-436b-86d5-38a9377bab1d]]` — Resource URI patterns
- `[[resource:a65d4861-05a4-4aa7-9176-d791d33cd1a3]]` — Prompt template patterns
- `assets/client-example.py` — MCP client usage
- `[[resource:bf6a1947-050a-43da-b4f0-dac6740a2eab]]` — CLI companion docs template
- `[[resource:95c2202a-06fe-4421-821b-30ee151238d6]]` — TypeScript CLI script template

## Reference Files

- `[[resource:c11596f1-cc1b-4a85-b849-c5fe87f7a211]]` — 30+ documented errors with fixes
...
- `[[resource:9ba78281-7d25-4359-9f81-4dcc5c0b896e]]` — FastAPI mount, OpenAPI import
- `[[resource:d9a90611-c146-4cae-bd96-eecb753d6258]]` — Lifespan, dependency injection
