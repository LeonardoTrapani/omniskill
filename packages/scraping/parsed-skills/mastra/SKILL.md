...
| ----------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------- |
| "Create/install Mastra project"     | [[resource:c01ab803-ad0e-4f13-bf64-cf947dd13249]]     | Setup guide with CLI and manual steps          |
| "How do I use Agent/Workflow/Tool?" | [[resource:ffd962b6-bde4-463c-8292-2d3ad2c859f9]]     | Look up in `node_modules/@mastra/*/dist/docs/` |
| "How do I use X?" (no packages)     | [[resource:f1fe96cd-9750-49fd-b6f1-e34d1b7018aa]]         | Fetch from `https://mastra.ai/llms.txt`        |
...
1. **Embedded docs first** (if packages installed)
   ...
   - **See:** [[resource:ffd962b6-bde4-463c-8292-2d3ad2c859f9]]
...
2. **Remote docs second** (if packages not installed)
   ...
   - **See:** [[resource:f1fe96cd-9750-49fd-b6f1-e34d1b7018aa]]
...
2. **Look up current API**
   - If installed → Use embedded docs [[resource:ffd962b6-bde4-463c-8292-2d3ad2c859f9]]
   - If not → Use remote docs [[resource:f1fe96cd-9750-49fd-b6f1-e34d1b7018aa]]
...
- **Setup**: [[resource:c01ab803-ad0e-4f13-bf64-cf947dd13249]]
- **Embedded docs lookup**: [[resource:ffd962b6-bde4-463c-8292-2d3ad2c859f9]] - Start here if packages are installed
- **Remote docs lookup**: [[resource:f1fe96cd-9750-49fd-b6f1-e34d1b7018aa]]
