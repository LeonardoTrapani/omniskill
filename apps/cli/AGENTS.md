...
This package is better-skills's command-line interface, built with `@clack/prompts` and connected to the server via tRPC.
...
- Use `@better-skills/env/cli` for runtime config (`SERVER_URL`). Do not hardcode host URLs.
